...
//    println()
  ...
  def makeAllPaths(grid: Array[Array[Char]], location: Location, finishLocation: Location, passcode: String, path: String, paths: Seq[String]): Seq[String] = {
